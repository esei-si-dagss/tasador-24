...
- Hace uso de la librería CBRKit (1) para la carga y gestión de la base de casos y (2) para la implementación de las métricas de similaridad utilizadas en la fase`recuperar`

  - Más detalles: [codigo y descarga](https://github.com/wi2trier/cbrkit/tree/main), [documentación](https://wi2trier.github.io/cbrkit/cbrkit.html),[paper de presentación](https://www.mirkolenz.com/static/ca607f149265ea90aea9579bd78a04bc/Lenz2024CBRkitIntuitiveCaseBased.pdf), [video de presentación](https://www.youtube.com/watch?v=27dG4MagDhE)
...
CBRKit es un proyecto en desarrollo y la librería está en cambio constante. Para este ejemplo y para la realización de la práctica de CBR se ha congelado en la versión 0.14.2 (la última compatible con Python 3.11)
